<html>
   <head>
      <title> Administrador | El Rinconcito </title>
         ...
         <nav class="navbar navbar-expand-md navbar-dark">
            ...
            <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
               <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
                  <li class="nav-item"> <a class="nav-link active" href="index.php"> &nbsp; Volver al inicio </a> </li>
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-sm-6 text-white">
                  <div class="px-5 ms-xl-4">
                     ...
                     <span class="h1 fw-bold mb-0">
                        <h1 class="fw-normal mb-3 pb-3"> &nbsp; &nbsp; </h1>
                     </span>
                  </div>
               ...
               <div class="col-sm-6 px-0 d-none d-sm-block">
                  <img src="img/fondo_login.jpg"
                     alt="Login image" class="w-100 vh-100" style="object-fit: cover; object-position: left;" width="1280" height="1050">
               </div>
            </div>
         </div>
      </section>
